...
//  ToDoList2
//
//  Created by Ksush Shishk on 09.07.2019.
...
//        tableView.reloadData()
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
       ...
       } else { cell.imageView?.image  = #imageLiteral(resourceName: "nocheck.png")   }
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if  changeState(at: indexPath.row) == true {
            ...
            tableView.cellForRow(at: indexPath)?.imageView?.image = #imageLiteral(resourceName: "nocheck.png")
